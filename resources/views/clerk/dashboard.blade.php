...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    <li class="submenu"> <a href="#"><i class="icon icon-folder-open"></i> <span>New Registration</span> <span class="label label-important"><i class="icon icon-chevron-down"></i></span></a>
      <ul>
        <li><a href="/clerk/child/register">Child Registration</a></li>
        <li><a href="/clerk/adult/register">Adult Registration</a></li>
      </ul>
    </li>
    ...
    <li class="submenu"> <a href="#"><i class="icon icon-eye-close"></i> <span>View Registered</span> <span class="label label-important"><i class="icon icon-chevron-down"></i></span></a>
      <ul>
        <li><a href="/clerk/births/view">Registered Children</a></li>
        <li><a href="/clerk/adult/view">Registered Adults</a></li>
      </ul>
    </li>
...
<div class="row-fluid">
  <div id="footer" class="span12"> 2017 &copy; ELgeyo Marakwet System. Designed by <a href="#">Mengich</a> </div>
</div>
