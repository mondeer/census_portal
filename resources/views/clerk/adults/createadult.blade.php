...
<div class="widget-box">
  ...
  <div class="widget-content nopadding">
    <form action="/clerk/adult/register" method="POST" class="form-horizontal">
      ...
      <div class="control-group">
        ...
        <label class="control-label">National No.</label>
        <div class="controls">
          <input class="span7" type="text" name="national_id" value="{{old('national_id')}}" placeholder="Enter National Id" required>
        </div>
